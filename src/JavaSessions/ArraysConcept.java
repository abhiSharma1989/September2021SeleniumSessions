...
public class ArraysConcept {
	...
	public static void main(String[] args) {
		...
		// 1. size is fixed (static array): to overcome this problem, use dynamic array
		// -- ArrayList
		// 2. similar type of data: to overcome this problem, use dynamic array --
		// ArrayList/Static Object Array
