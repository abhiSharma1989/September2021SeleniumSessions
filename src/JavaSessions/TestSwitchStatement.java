...
//		}
		...
		switch (Environment.trim().toString()) {
		case "Prod": {
			System.out.println("Login to Production Environment");
			break;
		}
		case "Staging": {
			System.out.println("Login to Staging Environment");
			break;
		}
		case "Test": {
			System.out.println("Login to Test Environment");
			break;
		}
		case "Dev": {
			System.out.println("Login to Dev Environment");
			break;
		}
		default:
